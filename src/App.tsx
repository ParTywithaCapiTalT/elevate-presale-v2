      ...
      <section className="relative pt-40 pb-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-left">
        ...
        <div className="flex justify-center lg:justify-end">
          <img 
            ...
            className="w-full max-w-lg h-auto object-contain drop-shadow-[0_0_50px_rgba(249,115,22,0.15)]"
          />
        </div>
      </section>
      ...
      <section id="whitelist" className="max-w-3xl mx-auto px-6 py-20 border-t border-white/5">
        <div className="p-8 md:p-12 bg-gradient-to-b from-white/[0.03] to-transparent border border-white/5 rounded-3xl relative overflow-hidden">
          ...
          {formSubmitted ? (
            ...
            /* REMEMBER TO PASTE YOUR CUSTOM FORMSPREE LINK IN THE ACTION BELOW */
            <form 
              ...
              className="space-y-6"
            >
              {/* Hidden input to capture the selected phase tier */}
              ...
              {/* NEW INVESTMENT QUANTITY INPUT BLOCK */}
              <div>
                <label className="block text-xs font-bold text-white/50 uppercase tracking-wider mb-2">Intended Investment Capital</label>
                <div className="flex space-x-3">
                  <input 
                    ...
                    min="0"
                    placeholder="0.00"
                    className="flex-1 px-4 py-3.5 bg-white/5 border border-white/10 focus:border-orange-500 focus:ring-1 focus:ring-orange-500/20 rounded-xl text-sm text-white placeholder-white/20 outline-none transition"
                  />
                  <select 
                    name="investmentCurrency"
                    className="px-4 py-3.5 bg-white/10 border border-white/10 focus:border-orange-500 rounded-xl text-sm text-orange-400 font-bold outline-none cursor-pointer"
                  >
                    <option value="ETH" className="bg-[#070a12] text-white">ETH</option>
                    <option value="USDT" className="bg-[#070a12] text-white">USDT</option>
                    <option value="USDC" className="bg-[#070a12] text-white">USDC</option>
                  </select>
                </div>
              </div>
